    ...
    try {
      ...
      try {
        while (nextPage == 'next') {
          ...
          //here we getting next page class name, using this in order to turn till last page, when it reaches last page classList will be undefined and loop will end
