  ...
  async getHouses(price) {
    ...
    try {
      ...
      while (nextPage == 'Növbəti') {
        ...
        const stringToCheck = "Your string here";
        
        const result = jschardet.detect(stringToCheck);
        ...
        languageEncoding('Növbəti').then((fileInfo) => console.log(fileInfo));

        console.log(typeof nextPage);

        console.log(nextPage === keyWord);
        console.log(typeof 'Növbəti');
