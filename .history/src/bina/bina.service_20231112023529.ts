  ...
  async getHouses(price) {
    ...
    try {
      ...
      let nextPage = 'Növbəti'
       ...
       nextPage = await page.$eval('.bottom_pagination .pagination-inner',(nextPage)=>{
          const result =  nextPage.querySelector('.next')?.textContent;
      ...
      //#js-items-search > div.bottom_pagination > nav > div > span.next > a
