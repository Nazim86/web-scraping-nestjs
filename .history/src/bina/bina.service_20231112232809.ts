  ...
  async getHouses(price) {
    ...
    try {
      ...
      while (nextPage == 'Növbəti') {
        ...
        const utf8String1 = iconv.decode(iconv.encode('Növbəti', 'utf-8'), 'utf-8');
        const utf8String2 = iconv.decode(iconv.encode("ada", 'utf-8'), 'utf-8');

        console.log(utf8String1 === utf8String2);

        x = jschardet.detect(utf8String1);

        console.log(x.encoding);

        x = jschardet.detect(utf8String2);
